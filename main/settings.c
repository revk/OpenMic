...
revk_settings_t const revk_settings[]={
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="spkpwr",.comment="Speaker power on",.group=1,.len=6,.dot=3,.def="38",.ptr=&spkpwr,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕"},
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="spklrc",.comment="Speaker LR clock",.group=1,.len=6,.dot=3,.def="35",.ptr=&spklrc,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕"},
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="spkbclk",.comment="Speaker Bit clock",.group=1,.len=7,.dot=3,.def="36",.ptr=&spkbclk,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕"},
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="spkdata",.comment="Speaker Data",.group=1,.len=7,.dot=3,.def="37",.ptr=&spkdata,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕"},
 ...
 {.type=REVK_SETTINGS_BIT,.name="micright",.comment="Microphone use right channel",.group=2,.len=8,.dot=3,.bit=REVK_SETTINGS_BITFIELD_micright,.live=1},
