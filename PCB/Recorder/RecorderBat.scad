...
{
translate([-4.950000,-9.500000,1.200000])rotate([0,0,90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
...
{
translate([15.000000,11.500000,1.200000])rotate([0,0,180.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
...
{
translate([21.000000,2.000000,1.200000])rotate([0,0,180.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
module part_R13(part=true,hole=false,block=false)
{
translate([21.000000,12.000000,1.200000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
...
{
translate([-10.000000,7.500000,1.200000])rotate([0,0,-90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
...
{
translate([-7.900000,-9.500000,1.200000])rotate([0,0,-90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
module part_R3(part=true,hole=false,block=false)
{
translate([0.150000,-9.500000,1.200000])rotate([0,0,90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
...
{
translate([10.000000,7.400000,1.200000])rotate([0,0,-90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
...
{
translate([-10.000000,9.000000,1.200000])rotate([0,0,-90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
...
{
translate([-0.700000,-9.500000,1.200000])rotate([0,0,90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
...
{
translate([20.500000,7.000000,1.200000])rotate([0,0,90.000000])translate([0.000000,-1.900000,0.000000])rotate([90.000000,0.000000,0.000000])m5(part,hole,block,casetop); // RevK:USB-C-Socket-H CSP-USC16-TR (back)
};
...
{
translate([10.200000,-8.900000,1.200000])rotate([0,0,-90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
module part_D1(part=true,hole=false,block=false)
{
translate([19.200000,-0.500000,1.200000])rotate([0,0,-90.000000])m6(part,hole,block,casetop); // RevK:D_0402 DFN1006-2L (back)
};
module part_C12(part=true,hole=false,block=false)
{
translate([-4.950000,-11.000000,1.200000])rotate([0,0,-90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
module part_C9(part=true,hole=false,block=false)
{
translate([14.562500,-4.500000,1.200000])m7(part,hole,block,casetop); // RevK:C_0805 C_0805_2012Metric (back)
};
module part_D3(part=true,hole=false,block=false)
{
translate([16.500000,8.500000,1.200000])rotate([0,0,90.000000])m8(part,hole,block,casetop); // D3 (back)
};
module part_D2(part=true,hole=false,block=false)
{
translate([21.100000,-1.000000,1.200000])m6(part,hole,block,casetop); // RevK:D_0402 DFN1006-2L (back)
};
...
{
translate([-3.250000,-9.500000,1.200000])rotate([0,0,90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
...
{
translate([-1.550000,-9.500000,1.200000])rotate([0,0,90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
module part_R15(part=true,hole=false,block=false)
{
translate([-7.200000,-9.500000,1.200000])rotate([0,0,90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
module part_U1(part=true,hole=false,block=false)
{
translate([1.000000,-0.500000,1.200000])m9(part,hole,block,casetop); // U1 (back)
};
module part_C2(part=true,hole=false,block=false)
{
translate([9.400000,6.800000,1.200000])rotate([0,0,-90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
module part_C4(part=true,hole=false,block=false)
{
translate([-7.500000,4.180000,1.200000])rotate([0,0,90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
module part_R6(part=true,hole=false,block=false)
{
translate([-2.400000,-9.500000,1.200000])rotate([0,0,90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
...
{
translate([21.200000,-7.500000,1.200000])rotate([0,0,180.000000])translate([0.000000,1.200000,0.000000])rotate([-0.000000,-0.000000,180.000000])m10(part,hole,block,casetop); // RevK:1.25T-2PWT (Molex 532610271) Molex_PicoBlade_53261-0271_1x02-1MP_P1.25mm_Horizontal (back)
};
module part_C6(part=true,hole=false,block=false)
{
translate([11.000000,-5.500000,1.200000])rotate([0,0,90.000000])m11(part,hole,block,casetop); // C6 (back)
};
module part_R9(part=true,hole=false,block=false)
{
translate([-4.100000,-9.500000,1.200000])rotate([0,0,90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
module part_R14(part=true,hole=false,block=false)
{
translate([-6.500000,-9.500000,1.200000])rotate([0,0,-90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
module part_C5(part=true,hole=false,block=false)
{
translate([11.000000,7.500000,1.200000])rotate([0,0,-90.000000])m4(part,hole,block,casetop); // RevK:C_0603 C_0603_1608Metric (back)
};
module part_R8(part=true,hole=false,block=false)
{
translate([12.600000,6.600000,1.200000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
module part_C14(part=true,hole=false,block=false)
{
translate([7.200000,-11.000000,1.200000])rotate([0,0,-90.000000])m1(part,hole,block,casetop); // RevK:R_0201 C_0201_0603Metric (back)
};
module part_C7(part=true,hole=false,block=false)
{
translate([17.000000,11.500000,1.200000])m12(part,hole,block,casetop); // RevK:C_0402 C_0402_1005Metric (back)
};
...
{
translate([-4.350000,-1.050000,0.000000])rotate([0,0,90.000000])rotate([180,0,0])m13(part,hole,block,casebottom); // J4
};
...
{
translate([8.500000,0.000000,0.000000])rotate([0,0,180.000000])rotate([180,0,0])m14(part,hole,block,casebottom); // BT1
};
